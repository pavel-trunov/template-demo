"""CLI (Command Line Interface) of template-demo."""
...
cli = typer.Typer(help="Command Line Interface of template-demo")
...
if find_spec("nicegui") and find_spec("webview") and not __is_running_in_container__:
    ...
    def gui() -> None:
        ...
        gui_run(native=True, with_api=False, title="template-demo", icon="🧠")
...
prepare_cli(cli, f"🧠 template-demo v{__version__} - built with love in Berlin 🐻")
